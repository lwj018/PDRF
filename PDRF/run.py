...
class Runner(object):
    ...
    def _preparation(self):
        ...
        self.exp_dir    = osp.join(cur_dir, 'Exps_ceshi_code', self.args.exp_dir, self.exp_name)        
    ...
    def _sample_batch(self, batch, use_ema=False, vis_diff=False):
        ...
        extrapolated_condition2 = self.extrapolator.build_condition(condition, extrapolated_condition)
        pred = rf.sampleno(self.model,z,condition,device = torch.device('cuda:' + str(cuda_idx)))
