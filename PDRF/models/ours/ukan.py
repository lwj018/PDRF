...
class UKan_Hybrid(nn.Module):
    ...
    def forward(self, x,):
        ...
        ### Stage 4
        h = swish(F.interpolate(self.decoder1(h), scale_factor=(2,2), mode ='bilinear'))
        ...
        h = swish(F.interpolate(self.decoder2(h),scale_factor=(2,2),mode ='bilinear'))   #[8, 128, 36, 36]
        h = torch.add(h,t3)
...
if __name__ == '__main__':
    model = UKan_Hybrid(
        T=1000,in_ch=5,out_ch=20, ch=64, ch_mult=[1, 2, 2, 2], attn=[],
